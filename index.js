...
// tourServices
// Zg2pWkjHS6Nnnamu
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.t8s5g.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
console.log(uri)
...
app.get('/', (req, res) => {
  res.send('Hello World! Welcom to Our Server')
})
